    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Dinner 2 U - 2021 <a href="http://localhost/Dinner2U%20-%20IT%20Elective%201%20&%202/index.php?page=home" target="_blank">The Greatest Trio</a></div></div>
        </footer>
